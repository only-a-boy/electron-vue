<template>
    <div class="content">
        <div class="http404">
            ...
            <div class="text">
                <div class="text__oops">出错了!</div>
                <div class="text__headline">{{ message }}</div>
                <div class="text__info">请检查您输入的网址是否正确，请点击以下按钮返回主页或者发送错误报告</div>
                <div class="text__return-home" @click="_back">返回首页</div>
            </div>
        </div>
    </div>
</template>
